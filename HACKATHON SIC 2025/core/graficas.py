...
class GeneradorGraficas:
    ...
    def __init__(self):
        ...
        # Configurar estilo matplotlib personalizado con nuevos colores
        plt.style.use('default')  # Reset to default
        plt.rcParams.update({
            'figure.facecolor': COLORES['bg_panel'],
            'axes.facecolor': COLORES['bg_secundario'],
            'axes.edgecolor': COLORES['borde_normal'],
            'axes.labelcolor': COLORES['texto_principal'],
            'xtick.color': COLORES['texto_secundario'],
            'ytick.color': COLORES['texto_secundario'],
            'text.color': COLORES['texto_principal'],
            'grid.color': COLORES['metal_claro'],
            'grid.alpha': 0.3
        })
