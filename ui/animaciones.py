...
class AnimacionPulso:
    ...
    def _animar(self):
        ...
        # Interpolación sinusoidal para efecto suave
        import math
...
class AnimacionRotacion:
    ...
    def _rotar(self):
        ...
        # Rotar el elemento (implementación básica)
        # Para rotación real de imágenes, necesitarías PIL
...
class GestorAnimaciones:
    ...
    def pulso(self, widget, color_inicial=None, color_final=None):
        ...
        if color_final is None:
            color_final = COLORES['acento_naranja']
